...
-- Runeforged Gloves (PoE2 0.5+): Runeforging replaces base Armour/Evasion/ES with
-- Runic Ward. PoB does not yet calculate Runic Ward; the base type entries exist
-- so Runeforged items can be imported and their explicit mods evaluated.
