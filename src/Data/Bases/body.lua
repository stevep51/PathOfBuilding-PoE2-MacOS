...
-- Runeforged base types (PoE2 0.5+) are manually appended; they should be
-- included in the next upstream data export.
local itemBases = ...
...
-- Runeforged Body Armours (PoE2 0.5+): Runeforging replaces base Armour/Evasion/ES
-- with Runic Ward. PoB does not yet calculate Runic Ward; the base type entries
-- exist so Runeforged items can be imported and their explicit mods evaluated.
